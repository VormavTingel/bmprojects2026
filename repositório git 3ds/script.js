...
const conteudos = [
    ...
    { area: "HTML", nome: "select", categoria: "Formulários", descricao: "Cria um controle para escolher uma ou mais opções." },
    ...
    { area: "CSS", nome: "max()", categoria: "Funções CSS", descricao: "Escolhe o maior valor entre opções." },
